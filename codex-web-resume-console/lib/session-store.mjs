...
export class SessionStore {
  ...
  createSession(input = {}) {
    ...
    const session = normalizeSession({
      ...
      tokenUsageBaselineTotal: normalizeOptionalNumber(input.tokenUsageBaselineTotal),
...
function normalizeSession(raw) {
  ...
  const session = {
    ...
    tokenUsageBaselineTotal: normalizeOptionalNumber(raw?.tokenUsageBaselineTotal),
